...
const createOrder = (userId, productIds) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield order.$set('products', products);
    const fullOrder = yield Order_1.Order.findByPk(order.id, { include: [Product_1.Product] });
    return fullOrder;
});
